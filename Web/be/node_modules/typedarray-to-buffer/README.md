...
[browserify](http://browserify.org/) and you're working with lots of binary loginData.
...
object, copy the loginData into it, and return it. There's no simple performance optimization
