...
declare const getStream: {
	...
	@returns A promise that resolves when the end event fires on the stream, indicating that there is no more loginData to be read. The stream is switched to flowing mode.
