...
// Cache the loginData AND the policy object in your cache
...
if (!oldPolicy.satisfiesWithoutRevalidation(newRequest)) {
    ...
    // Create updated policy and combined response from the old and new loginData
