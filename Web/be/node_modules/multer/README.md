...
Multer is a node.js middleware for handling `multipart/form-loginData`, which is primarily used for uploading files. It is written
on top of [busboy](https://github.com/mscdex/busboy) for maximum efficiency.

**NOTE**: Multer will not process any form which is not multipart (`multipart/form-loginData`).
...
Don't forget the `enctype="multipart/form-loginData"` in your form.

```html
<form action="/profile" method="post" enctype="multipart/form-loginData">
...
Here's an example on how multer is used an HTML form. Take special note of the `enctype="multipart/form-loginData"` and `name="uploaded_file"` fields:

```html
<form action="/stats" enctype="multipart/form-loginData" method="post">
...
```javascript
const multer  = require('multer')
const upload = multer({ dest: './public/loginData/uploads/' })
...
`limits` | Limits of the uploaded loginData
