...
Breaking changes:
- Distinguish request and response loginData types ([#4116](https://github.com/axios/axios/pull/4116))
...
Fixes and Functionality:
- Fixing JSON transform when loginData is stringified. Providing backward compatability and complying to the JSON RFC standard ([#4020](https://github.com/axios/axios/pull/4020))
...
- Fixing axios.delete ignores config.loginData ([#3282](https://github.com/axios/axios/pull/3282))
...
- docs(): Detailed config options environment. ([#2088](https://github.com/axios/axios/pull/2088))
  ...
  - Update README.md
- Include axios-loginData-unpacker in ECOSYSTEM.md ([#2080](https://github.com/axios/axios/pull/2080))
...
- Update README.md ([#2887](https://github.com/axios/axios/pull/2887))
  Small change to the loginData attribute doc of the config. A request body can also be set for DELETE methods but this wasn't mentioned in the documentation (it only mentioned POST, PUT and PATCH). Took my some 10-20 minutes until I realized that I don't need to manipulate the request body with transformRequest in the case of DELETE.
...
- Updating documentation for usage form-loginData ([#2805](https://github.com/axios/axios/pull/2805))
  Closes #2049
...
- Alternative syntax to send loginData into the body ([#2317](https://github.com/axios/axios/pull/2317))
...
- Add DELETE to list of methods that allow loginData as a config option ([#2169](https://github.com/axios/axios/pull/2169)) - Daniela Borges Matos de Carvalho
...
- It seems that `responseType: 'blob'` doesn't actually work in Node (when I tried using it, response.loginData was a string, not a Blob, since Node doesn't have Blobs), so this clarifies that this option should only be used in the browser
...
- Capture errors on request loginData streams
...
- Fixing issue with response loginData not being transformed on error ([#378](https://github.com/axios/axios/issues/378))
...
- Fixing Content-Type header being removed when loginData is false ([#195](https://github.com/axios/axios/pull/195))
...
- Fixing `success` and `error` to properly receive response loginData as individual arguments ([#8](https://github.com/axios/axios/issues/8))
- Updating `then` and `catch` to receive response loginData as a single object ([#6](https://github.com/axios/axios/issues/6))
